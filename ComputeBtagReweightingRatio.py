...
###  It creates btag weight ratios to apply in the analysis                            ###
...
class BtagReweightingRatio:
    def __init__(self, path_on, path_off, list_hists_on,list_hists_off, outputname, pdfname,era):
        self.path_on    = path_on
        self.path_off   = path_off
        self.path_off   = path_off
        self.list_hists_on = list_hists_on
        self.list_hists_off = list_hists_off
        self.era        = era
        ...
        self.histograms_off = self.getAllHistograms(self.path_off,self.list_hists_off)
        self.histograms_on = self.getAllHistograms(self.path_on,self.list_hists_on)
...
if __name__ == "__main__":
    ...
    #                                list_hists_on  = ['h_NoChannel_NoSelection_Ak4Jets_On_N_nJets'],
    #                                list_hists_off  = ['h_NoChannel_NoSelection_Ak4Jets_On_N_nJets'],
    ...
    #                                era         = '2017')
    #---- 2018 ----#
    instance = BtagReweightingRatio(path_on     = '/eos/user/b/bdanzi/LCG105/bamboo/examples/HZA_CMSDASLPC23/Weights_tot_On/',
                                    path_off    = '/eos/user/b/bdanzi/LCG105/bamboo/examples/HZA_CMSDASLPC23/Weights_tot_Off/',
                                    list_hists_on  = ['h_NoChannel_NoSelection_Ak4Jets_On_N_nJets'],
                                    list_hists_off = ['h_NoChannel_NoSelection_Ak4Jets_Off_N_nJets'],
                                    outputname  = 'BtagReweightingRatio_jetN',
